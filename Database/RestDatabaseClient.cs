...
namespace MultiplayerARPG.MMO
{
    public partial class RestDatabaseClient : RestClient, IDatabaseClient
    {
        ...
        {
            return await SendRequest<GetUserUnlockContentsReq, UserUnlockContentsResp>(request, DatabaseApiPath.GetUserUnlockContents, nameof(GetUserUnlockContentsAsync));
        }
        ...
        {
            return await SendRequest<GetAllUserUnlockContentsReq, UserUnlockContentsResp>(request, DatabaseApiPath.GetAllUserUnlockContents, nameof(GetAllUserUnlockContentsAsync));
        }
        ...
        {
            return await SendRequest<ChangeUserUnlockContentProgressionReq, UserUnlockContentResp>(request, DatabaseApiPath.ChangeUserUnlockContentProgression, nameof(ChangeUserUnlockContentProgressionAsync));
        }

        public async UniTask<DatabaseApiResult> UpdateUserUnlockContentAsync(UpdateUserUnlockContentReq request)
        {
            return await SendRequest(request, DatabaseApiPath.UpdateUserUnlockContent, nameof(UpdateUserUnlockContentAsync));
        }

        public async UniTask<DatabaseApiResult<UserUnlockContentResp>> GetUserUnlockContentAsync(GetUserUnlockContentReq request)
        {
            return await SendRequest<GetUserUnlockContentReq, UserUnlockContentResp>(request, DatabaseApiPath.GetUserUnlockContent, nameof(GetUserUnlockContentAsync));
        }
        ...
        {
            return await SendRequest(request, DatabaseApiPath.RemoveGuildCache, nameof(RemoveGuildCacheAsync));
        }

        public async UniTask<DatabaseApiResult> RemovePartyCacheAsync(GetPartyReq request)
        {
            return await SendRequest(request, DatabaseApiPath.RemovePartyCache, nameof(RemovePartyCacheAsync));
        }
    }
}